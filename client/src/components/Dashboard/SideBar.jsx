    ...
    <aside className="hidden h-screen w-72 shrink-0 flex-col border-r border-border-sage/40 bg-background shadow-sm lg:flex">
      ...
      <div className="border-t border-border-sage/40 p-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-heading bg-transparent px-5 py-3 text-xs uppercase tracking-widest font-semibold text-heading transition duration-300 hover:bg-heading hover:text-background cursor-pointer"
        >
          <LogOut size={16} />
          Logout
        </button>
